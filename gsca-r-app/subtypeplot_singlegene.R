...
plot <- box_plot_single_gene_single_cancer(data = for_plot,aesx = "group",aesy="expr",color = "group_n",color_name = "Subtypes",color_labels =  color_list$group,color_values = color_list$color,title = title,xlab = 'Subtypes', ylab = 'Expression log2(RSEM)',xangle = 0,comp_list=comp_list)
