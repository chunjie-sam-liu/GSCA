...
box_plot <- box_plot_single_gene_multi_cancers(data = for_plot,aesx = "subtype",aesy="gsva",facets=".~cancertype",color = "cancertype",color_name = "",color_labels = color_list$cancertype,color_values = color_list$color,title = "GSVA score in selected cancer types subtypes", xlab = 'Subtypes', ylab = 'GSVA score') +
