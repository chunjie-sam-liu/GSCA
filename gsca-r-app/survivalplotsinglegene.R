...
# search_str = 'CD1B@KICH_expr_survival'
...
fields <- '{"symbol": true, "pval": true,"sur_type": true,"_id": false}'
...
combine_data_group %>%
  ...
  fn_survival(title,color_list,logrankp=fetched_expr_survival$pval) -> plot
