...
export class CnvCorComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  public exportExcel() {
    const workSheet = XLSX.utils.json_to_sheet(this.dataSourceCnvCor.data, { header: this.displayedColumnsCnvCor });
    const workBook: XLSX.WorkBook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(workBook, workSheet, 'SheetName');
    XLSX.writeFile(workBook, 'CnvAndExpressionTable.xlsx');
  }
}
