...
export class ImmuneCnvGsvaComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  immGenesetCnvCorSingleGeneImageLoading = false;
  ...
  public exportExcel() {
    const workSheet = XLSX.utils.json_to_sheet(this.dataSourceImmGenesetCnvCor.data, { header: this.displayedColumnsImmGenesetCnvCor });
    const workBook: XLSX.WorkBook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(workBook, workSheet, 'SheetName');
    XLSX.writeFile(workBook, 'ImmuneAndGenesetCnvTable.xlsx');
  }
}
